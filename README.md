...
wget http://bioinformatics.bc.edu/~jsa/aerial.aerosaite-1.4.2-standalone.jar
...
`java -jar aerial.aerosaite-1.4.2-standalone.jar --install`
...
`java -jar aerial.aerosaite-1.4.2-standalone.jar --update`
