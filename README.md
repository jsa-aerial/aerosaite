...
wget http://bioinformatics.bc.edu/~jsa/aerial.aerosaite-1.3.0-standalone.jar
...
`java -jar aerial.aerosaite-1.3.0-standalone.jar --install`
...
`java -jar aerial.aerosaite-1.3.0-standalone.jar --update`
